...
import 'package:budget_management/models/daily.dart';
...
class DailyAddTransaction extends StatefulWidget {
  const DailyAddTransaction({Key? key}) : super(key: key);

  @override
  _DailyAddTransactionState createState() =>
      _DailyAddTransactionState();
}

class _DailyAddTransactionState extends State<DailyAddTransaction> {
  String userId = "";
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        uploadTransaction(transaction).whenComplete(() => Navigator.pop(context));
                      },
                      child: Container(
                        width: 50,
                        height: 50,
